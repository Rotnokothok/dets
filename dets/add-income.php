...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblincome(ID,UserId,IncomeDate,IncomeFrom,income) value('$id','$userid','$dateexpense','$item','$costitem')");
if($query){
...
<head>
	...
	<title>Daily Income & Expense System || Add Income</title>
						...
						<div class="col-md-12">
							...
							<form role="form" method="post" action="">
								...
								<div class="form-group">
									<label>IncomeI ID</label>
									<input type="text" class="form-control" name="id" value="" required="true">
								</div>
