...
<head>
	...
	<title>Daily Income & Expense System - Signup</title>
...
<body style="background-image: url(ju.jpg); overflow:hidden;>
	<div class="row">
			<h2 align="center" style="color:white">Daily Income & Expense System</h2>
			<h4 align="center" style="color:white">Supervised by Dr.Shamim al Mamun</h4>
	<hr />
    ...
    echo $msg;
						...
						<fieldset>
							...
							<div class="form-group">
								<input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" maxlength="12" pattern="[0-9]{10}" required="true">
							</div>
							<div class="form-group">
							...
							<div class="checkbox">
								<button type="submit" value="submit" name="submit" class="btn btn-primary">Register</button><span style="padding-left:100px">
